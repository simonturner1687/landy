...
<div class="bodywrapper">
    ...
    <div class="vernav">
        <ul>
            ...
            <li class="current"><a href="trash_posts.php">Trash</a></li>
        </ul>
    ...
    <div class="centercontent">
        ...
        <div class="pageheader">
            ...
            $Posts = new Posts();
            $posts = $Posts->get_blog_posts('', 'trash');?>

            <ul class="hornav blogmenu">
                <li class="current"><a href="#">Trash Posts (<?php echo count($posts);?>)</a></li>
            </ul>
        </div><!--pageheader-->
    ...
    <tbody>
        <tr>
            ...
            <td class="actions aligncenter">
                <a href="edit_post.php?id='.$blogArray["id"].'">Edit</a> <a href="../../blog-post.php?title='.$title.'">View</a> <a href="delete.php?id='.$blogArray["id"].'" class="delete">Delete</a>
            </td>
        </tr>';
    }
}
