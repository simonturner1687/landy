...
<div class="bodywrapper">
    ...
    <div class="vernav">
        ...
        <ul>
            ...
            <li class="current"><a href="draft_retreats.php">Draft Retreats</a></li>
    ...
    <div class="centercontent">
        ...
        <div class="pageheader">
            ...
            $Posts = new Posts();
            $retreats = $Posts->get_retreats('', 'draft');?>

            <ul class="hornav blogmenu">
                <li class="current"><a href="#">Draft Retreats (<?php echo count($retreats);?>)</a></li>
            </ul>
        </div><!--pageheader-->
    ...
    <tbody>
        <tr>
            ...
            <td class="con0 actions aligncenter">
                <a href="edit_post.php?id='.$retreatArray["id"].'">Edit</a> <a href="../../blog-post.php?title='.$title.'">View</a> <a href="archived_retreats.php?id='.$retreatArray["id"].'" class="delete">Archive</a> 
            </td>
        </tr>';
    }
}
