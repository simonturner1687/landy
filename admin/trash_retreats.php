...
<div class="bodywrapper">
    ...
    <div class="vernav">
        ...
        <ul>
            ...
            <li class="current"><a href="trash_retreats.php">Trash </a></li>
        </ul>
        <ul>
    ...
    <div class="centercontent">
        ...
        <div class="pageheader">
            ...
            $Posts = new Posts();
            $retreats = $Posts->get_retreats('', 'trash');?>

            <ul class="hornav blogmenu">
                <li class="current"><a href="#">Trash Retreats (<?php echo count($retreats);?>)</a></li>
            </ul>
        </div><!--pageheader-->
