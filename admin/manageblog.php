...
<div class="bodywrapper">
    ...
    <div class="vernav">
    	<ul>
            ...
            <li class="current"><a href="manageblog.php" class="editor">All Posts</a></li>
    ...
    <div class="centercontent">
        ...
        <div class="pageheader">
            ...
            $Posts = new Posts();
            $posts = $Posts->get_blog_posts();?>

            <ul class="hornav blogmenu">
                <li class="current"><a href="#">All Posts (<?php echo count($posts);?>)</a></li>
            </ul>
        </div><!--pageheader-->
    ...
    <tbody>
        <tr>
            ...
            <td class="actions aligncenter">
                <a href="edit_post.php?id='.$blogArray["id"].'">Edit</a> <a href="../blog-single.php?title='.$title.'">View</a> <a href="trash.php?id='.$blogArray["id"].'" class="delete">Delete</a>
            </td>
        </tr>';
    }
}
