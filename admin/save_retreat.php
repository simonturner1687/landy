...
foreach ($imagearray as $image )
{
    if (!empty($image['name']))
    {
        ...
        $Posts = new Posts();
        $posts = $Posts->save_retreat($id, $location, $hotel, $type, $short_content, $content, $date, $fullprice, $deposit, $open, $filled, $status, $image_1['name'], $image_2['name'], $image_3['name'], $image_4['name'], $image_5['name'], $image_6['name']);    
        session_start();
        $_SESSION['message'] = 'Retreat Update Successful';
        header('Location: manageretreat.php'); 
