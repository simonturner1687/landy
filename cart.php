				...
				<div class="container clearfix">
					...
					<nav id="primary-menu">
						...
						<ul>
							...
							<li class="current"><a href="#"><div>Products</div></a>
								<ul>
							...
							<li class="mega-menu"><a href="#"><div>Fitting Service</div></a>
								...
								<table class="table cart">
									<tbody>
										...
										<tr class="cart_item">
											...
											<tr>
												<td><a href="shop.html" class="button button-3d notopmargin ">Proceed to Checkout</a></td>
												<td></td>
											</tr>
										</tr>
									</tbody>
