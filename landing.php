...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<header id="header" class="transparent-header page-section dark">
			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="index.html" class="standard-logo" style="padding-top: 25px; color: #fff;"><strong>Land Rover Automotive</strong></a>
						<a href="index.html" class="retina-logo" style="padding-top: 25px;color: #fff;"><strong>Land Rover Automotive</strong></a>
					</div><!-- #logo end -->
					...
					<nav id="primary-menu">
						...
						<ul class="one-page-menu">
							...
							<li><a href="#" data-href="#section-features"><div>Products</div></a></li>
							<li><a href="#" data-href="#section-pricing"><div>Shipping</div></a></li>
							<li><a href="#" data-href="#section-testimonials"><div>Testimonials</div></a></li>
							<li><a href="#" data-href="#section-specs"><div>About</div></a></li>
							<li><a href="#" data-href="#section-buy"><div>Contact</div></a></li>
						</ul>
		...
		<section id="slider" style="background: url(images/landy.jpg) center; overflow: visible;" data-height-lg="500" data-height-md="500" data-height-sm="600" data-height-xs="600" data-height-xxs="600">
			<div class="container clearfix">
...
<div class="container clearfix">
					...
					<div class="col-md-12 nobottommargin">
							...
							<div class="heading-block center bottommargin-sm">
								<h2>Land Rover Automotive</h2>
								<span></span>
							</div>

							<p>Welcome to Land Rover Automotive, we are an independent Land Rover Defender interior specialist making high quality leather Land Rover seats and accessories, we also stock quality products from a range of manufacturers and suppliers of Land Rover replacement parts and upgrades, ensuring availability and choice is not an issue.</p>
				...
				<div class="container clearfix">
					...
					<div class="postcontent nobottommargin col_last">
						...
						<div id="shop" class="shop product-3 clearfix">
							...
							<div class="product clearfix">
								<div class="product-image">
									...
									<div class="product-overlay">
										<div><a href="#" class="add-to-cart"><i class="icon-shopping-cart"></i><span> Add to Cart</span></a></div>
										<div><a href="include/ajax/shop-item.html" class="item-quick-view" data-lightbox="ajax"><i class="icon-zoom-in2"></i><span> Quick View</span></a></div>
									</div>
								</div>
								<div class="product-desc center">
									<div class="product-title"><h3><a href="#">FULL LEATHER HEATED </a></h3></div>
							...
							<div class="product clearfix">
								<div class="product-image">
									<a href="#"><img src="images/shop/dress/1-1.jpg" alt="Slim Fit Chinos"></a>
									<a href="#"><img src="images/shop/dress/1.jpg" alt="Slim Fit Chinos"></a>
									<div class="product-overlay">
								...
								<div class="product-desc center">
									<div class="product-title"><h3><a href="#">DEFENDER SEATS CUBBY </a></h3></div>
							...
							<div class="product clearfix">
									...
									<div class="fslider" data-arrows="false">
										<div class="flexslider">
											<div class="slider-wrap">
												<div class="slide"><a href="#"><img src="images/shop/dress/2.jpg" alt="Dark Brown Boots"></a></div>
											</div>
										</div>
									</div>
									<div class="product-overlay">
								...
								<div class="product-desc center">
									<div class="product-title"><h3><a href="#">FULL REAR LOAD AREA MAT</a></h3></div>
							...
							<div class="product clearfix">
								<div class="product-image">
									<a href="#"><img src="images/shop/dress/2-1.jpg" alt="Light Blue Denim Dress"></a>
								...
								<div class="product-desc center">
									<div class="product-title"><h3><a href="#">FULL REAR LOAD AREA MATs</a></h3></div>
							...
							<div class="product clearfix">
								<div class="product-image">
									<a href="#"><img src="images/shop/dress/2-2.jpg" alt="Unisex Sunglasses"></a>
							...
							<div class="product clearfix">
								<div class="product-image">
									<a href="#"><img src="images/shop/dress/4-1.jpg" alt="Blue Round-Neck Tshirt"></a>
					...
					<div class="sidebar nobottommargin">
						<div class="sidebar-widgets-wrap">
							...
							<div class="widget widget_links clearfix">
								...
								<ul>
									<ul class="list-group">
							<li class="list-group-item">Defender</li>
							<li class="list-group-item">Discovery</li>
							<li class="list-group-item">Range Rover</li>
							<li class="list-group-item">Freelander</li>
							<li class="list-group-item">Series 1/2/3</li>
							<li class="list-group-item">Interior Accessories</li>
							<li class="list-group-item">Exterior / Other</li>
