      ...
      if (($this->pages) > 1) {
        ...
        if ($this->page != 1) {
          if ($this->_showFirstAndLast) {
            $plinks[] = ' <li><a href="?page=1'.$queryUrl.'"><i class="fa fa-long-arrow-left"> First </a></li> ';
          }
          $plinks[] = ' <li><a href="?page='.($this->page - 1).$queryUrl.'"><i class="fa fa-long-arrow-left"></i> Prev</a></li> ';
        }
        ...
        if ($this->page < $this->pages) {
          $slinks[] = ' <li><a href="?page='.($this->page + 1).$queryUrl.'"> Next <i class="fa fa-long-arrow-right"></i></a></li> ';
          if ($this->_showFirstAndLast) {
            $slinks[] = ' <li><a href="?page='.($this->pages).$queryUrl.'"> Last <i class="fa fa-long-arrow-right"></i></a></li> ';
          }
        }
